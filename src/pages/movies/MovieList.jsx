...
const MovieList = () => {
  ...
  const handleExport = (format) => {
    navigate('/movies/export', { state: { format } });
  };
  ...
  return (
    <Box>
      ...
      >
        ...
        <DialogContent>
          <DialogContentText>
            Are you sure you want to delete the movie "{filmToDelete?.title}"? This action cannot be undone.
          </DialogContentText>
        </DialogContent>
        <DialogActions>
